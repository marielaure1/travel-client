    ...
    mounted(){
        function getRandomImage() {
            axios.get('https://api.unsplash.com/photos/random', {
              ...
              params: {
                query: 'nature', // changer cette valeur pour une autre catégorie d'image
                orientation: 'landscape',
              },
            })
              .then(response => {
                // Utiliser l'URL de l'image pour définir le fond d'écran
          ...
          // Appeler la fonction getRandomImage() toutes les minutes
