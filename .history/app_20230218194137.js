...
if(document.querySelectorAll("#location-id")){
    document.querySelectorAll("#location-id").forEach((element) => {
        element.addEventListener("click", ()=>{
            routes.push({ path: '/:sluglocation', component: Location, name: 'location', props: {API_URL: API_URL, locationId: locationId} })
        })
    })
