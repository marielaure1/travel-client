export default {
    ...
    <span class="add" @click.prevent="close('.createLocation')"><iconify-icon icon="basil:cross-outline"></iconify-icon></span>
    ...
    <form @submit.prevent="updateLocation(show.id)" v-if="show" class="form showLocation">
