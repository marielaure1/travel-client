export default {
    ...
    methods: {
        dateFormat(){
            // Créez un objet Date en utilisant le timestamp
const date = new Date(timestamp);

// Utilisez les méthodes disponibles pour obtenir les différentes parties de la date et de l'heure
...
// Concaténez les différentes parties pour former la date au format YY-MM-DD HH:mm
const formattedDate = year + '-' + month + '-' + day + ' ' + hours + ':' + minutes;

console.log(formattedDate); // Affiche: 21-02-19 20:11
Dans cet exemple, nous avons créé un objet Date à partir du timestamp, puis nous avons utilisé les méthodes getFullYear, getMonth, getDate, getHours et getMinutes pour obtenir les différentes parties de la date et de l'heure. Nous avons également utilisé la méthode substr pour obtenir seulement les deux derniers chiffres de l'année, et les méthodes slice et ('0' + ...) pour ajouter un zéro devant les nombres qui ont une seule chiffre. Enfin, nous avons concaténé les différentes parties pour former la date au format YY-MM-DD HH:mm.
