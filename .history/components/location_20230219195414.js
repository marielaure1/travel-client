    ...
    template: `
        ...
        <div class="places" v-if="places.length">
            <div v-for="place in places" :key="place.updated_at">
                <form @click.prevent="updateVisited(place)">
                    <input type="checkbox" name="visited" value="{{ place.visited }}" id="place-input" v-model="place.visited" :checked="parseInt(place.visited) === 1" />
