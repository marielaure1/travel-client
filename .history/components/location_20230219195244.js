    ...
    template: `
        ...
        <div class="places" v-if="places.length">
            <div v-for="place in places" :key="place.updated_at">
                <input type="checkbox" name="visited" value="{{ place.vi }}" id="place-input" v-model="place.visited" :checked="parseInt(place.visited) === 1" @click.prevent="updateVisited(place)"/>
