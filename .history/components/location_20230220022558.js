export default {
    ...
    template: `
        ...
        <div class="grid-container">
            <div class="location">
                ...
                <iframe src="https://maps.google.com/?q={{location.lat}},{{location.lng}}" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <iframe 
  width="300" 
  height="170" 
  frameborder="0" 
  ...
  marginheight="0" 
  marginwidth="0" 
  src="https://maps.google.com/maps?q='+{{location.lat}}+','+YOUR_LON+'&hl=es&z=14&amp;output=embed"
 >
 </iframe>
            </div>
