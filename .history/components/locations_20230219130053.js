export default {
    ...
    <form @submit.prevent="updateLocation" v-if="show.length">
        ...
        <div v-if="responseUdate.name">
            <p v-for="response in responseUdate.name">{{response}}</p>
        </div>
        <input type="text" name="lat" placeholder="Latitude" v-model="show.lat">
        <div v-if="responseUdate.lat">
            <p v-for="response in responseUdate.lat">{{response}}</p>
        </div>
        <input type="text" name="lng" placeholder="Longitude" v-model="show.lng">
        <div v-if="responseUdate.lng">
            <p v-for="response in responseUdate.lng">{{response}}</p>
        </div>
        <button type="submit">Ajouter</button>
    </form>
    `, 
