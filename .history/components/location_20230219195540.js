    ...
    template: `
        ...
        <div class="places" v-if="places.length">
            <div v-for="place in places" :key="place.updated_at">
                    <input type="checkbox" name="visited" v-model="place.visited" :checked="parseInt(place.visited) === 1" @click.prevent="updateVisited(place) />
    ...
    methods: {
        ...
        updateVisited(a){
            let datas = {
                ...
                "name": a.name,
                "location_id": parseInt(this.$route.params.id)updateVisited
            }
