    ...
    template: `
        ...
        <div class="places" v-if="places.length">
            ...
            <div v-for="place in places" :key="place.updated_at">
                ...
                <label for="place-input">{{ place.name }}</label><input type="checkbox" name="visited" value="{{ place.id }}" id="place-input"  v-bind:checked="place.visited === 1" v-model="isvisited" @click.prevent="visited"/>
            </div>
