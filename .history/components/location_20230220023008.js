    ...
    template: `
        ...
        <div class="grid-container">
            <div class="location">
                ...
                <iframe src="https://maps.google.com/?q=${locationlat},${locationlat}" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
