    ...
    template: `
        ...
        <div class="places" v-if="places.length">
            ...
            <div v-for="place in places" :key="place.updated_at">
                <input type="checkbox" name="visited" value="{{ place.id }}" id="place-input"  v-bind:checked="place.visited === 1" v-model="isvisited" @click.prevent="updatePlace({"name" => place.name, "lat" => place.lat, "lng" => place.lng, "lng" => place.lng  })"/>
