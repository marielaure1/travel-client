    ...
    template: `
        ...
        <div class="places" v-if="places.length">
            <div v-for="place in places" :key="place.updated_at">
                    <input type="checkbox" v-model="place.visited" :checked="parseInt(place.visited) === 1"  />
                ...
                <form @submit.prevent="updatePlace(place)">
                    <input type="text" name="name" placeholder="Place" v-model="place.name">
                    <div v-if="responseUpdate.name">
                        <p v-for="response in responseUpdate.name">{{response}}</p>
                    </div>
                    <input type="text" name="lat" placeholder="Latitude" v-model="place.lat">
                    <div v-if="responseUpdate.lat">
                        <p v-for="response in responseUpdate.lat">{{response}}</p>
                    </div>
                    <input type="text" name="lng" placeholder="Longitude" v-model="place.lng">
                    <div v-if="responseUpdate.lng">
                        <p v-for="response in responseUpdate.lng">{{response}}</p>
                    </div>
                    <input type="checkbox" v-model="place.visited" "  />
                    <label>Visited</label>
