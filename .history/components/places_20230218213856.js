    ...
    template: `
        ...
        <div class="places" v-if="places.length">
                ...
                <div>
                    ...
                    <label for="place-input"><router-link :to="{ name: 'places', params: { sluglocation : place.slug, id : place.id }} class="card" v-for="place in places" :key="place.updated_at">{{ place.name }}</router-link></label>
