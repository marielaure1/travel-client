...
const options = {
    ...
    methods:{
        getRandomImage(){
            const bgImage = document.getElementById('app');
            fetch('https://api.unsplash.com/photos/random?query=voyage&orientation=landscape&client_id=jleEsR1LG-cvURkHBm8yQMFo1JceNzlMNbz3_iStBV4')
            .then(response => {
